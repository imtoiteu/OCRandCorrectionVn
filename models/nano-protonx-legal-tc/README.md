...
[![HuggingFace](https://img.shields.io/badge/HuggingFace-Model-black?logo=huggingface)](https://huggingface.co/protonx-models/nano-protonx-legal-tc)
...
- The model is 5× smaller than the teacher model.
